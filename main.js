    ...
    triggerScanline();
      ...
      (function () {
        ...
        (function () {
          ...
          var radarVals = [5, 4, 3, 5, 4];
          var radarLabels = ['Prompting', 'Iteration', 'Understanding', 'Reasoning', 'Verification'];

          // Create gradient fill for the data area
          var rctx2d = radarCanvas.getContext('2d');
          var gradient = rctx2d.createRadialGradient(120, 120, 0, 120, 120, 120);
          gradient.addColorStop(0, 'rgba(0, 230, 118, 0.25)');
          gradient.addColorStop(1, 'rgba(0, 230, 118, 0.04)');
          ...
          var radarChart = new Chart(radarCanvas, {
            ...
            data: {
              ...
              datasets: [{
                ...
                pointRadius: 4,
                pointHoverRadius: 6,
                pointHoverBackgroundColor: '#B6FFD7',
          ...
          // Update radar on pillar hover
          pillars.forEach(function (row, idx) {
            row.addEventListener('mouseenter', function () {
              var highlighted = radarVals.map(function (v, i) { return i === idx ? v : 0; });
              radarChart.data.datasets[0].data = highlighted;
              radarChart.update('none');
            });
            row.addEventListener('mouseleave', function () {
              radarChart.data.datasets[0].data = radarVals;
              radarChart.update('none');
            });
          });
